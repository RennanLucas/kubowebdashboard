...
import "@/components/landing/premium/landing-cinema.css";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Analytics próprio para acompanhar visitantes, páginas, fontes, conversões, alertas e insights do seu site em uma leitura clara."
        />
        <link rel="canonical" href="https://kubowebdashboard.vercel.app/" />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://kubowebdashboard.vercel.app/"
        />
        <meta
          property="og:title"
          content="Kubo Analytics | Entenda seu site. Decida melhor."
        />
        <meta
          property="og:description"
          content="Visitantes, páginas, fontes, conversões, alertas e insights em uma leitura clara."
        />
        <meta
          property="og:image"
          content="https://kubowebdashboard.vercel.app/og-image.png"
        />
